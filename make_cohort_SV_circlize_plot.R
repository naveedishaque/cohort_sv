...
circos.genomicLink(window_bed_direct_pos1    , window_bed_direct_pos1    , col="#CCCCCC30", border=0.5, lwd=2)
...
circos.genomicIdeogram()
circos.track(ylim=c(0, 1), panel.fun= function(x,y) {circos.text(CELL_META$xcenter, CELL_META$ycenter,gsub("chr","",CELL_META$sector.index))}, track.height=0.05, bg.border=NA)
circos.genomicLink(window_bed_near_pos1    , window_bed_near_pos1    , col="#CCCCCC30", border=0.5, lwd=2)
...
circos.genomicIdeogram()
circos.track(ylim=c(0, 1), panel.fun= function(x,y) {circos.text(CELL_META$xcenter, CELL_META$ycenter,gsub("chr","",CELL_META$sector.index))}, track.height=0.05, bg.border=NA)
circos.genomicLink(window_bed_close_pos1    , window_bed_close_pos1    , col="#CCCCCC30", border=0.5, lwd=2)
